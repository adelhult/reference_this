...
-file("/home/eli/dev/reference/build/packages/gleam_json/src/gleam/json.gleam", 87).
-spec decode_bits(
    bitstring(),
    fun((gleam@dynamic:dynamic_()) -> {ok, FXA} |
        {error, list(gleam@dynamic:decode_error())})
) -> {ok, FXA} | {error, decode_error()}.
...
-file("/home/eli/dev/reference/build/packages/gleam_json/src/gleam/json.gleam", 45).
-spec do_decode(
    binary(),
...
-file("/home/eli/dev/reference/build/packages/gleam_json/src/gleam/json.gleam", 37).
-spec decode(
    binary(),
    fun((gleam@dynamic:dynamic_()) -> {ok, FWS} |
        {error, list(gleam@dynamic:decode_error())})
) -> {ok, FWS} | {error, decode_error()}.
decode(Json, Decoder) ->
    do_decode(Json, Decoder).

-file("/home/eli/dev/reference/build/packages/gleam_json/src/gleam/json.gleam", 120).
-spec to_string(json()) -> binary().
to_string(Json) ->
    gleam_json_ffi:json_to_string(Json).

-file("/home/eli/dev/reference/build/packages/gleam_json/src/gleam/json.gleam", 141).
-spec to_string_builder(json()) -> gleam@string_builder:string_builder().
to_string_builder(Json) ->
    gleam_json_ffi:json_to_iodata(Json).

-file("/home/eli/dev/reference/build/packages/gleam_json/src/gleam/json.gleam", 158).
-spec string(binary()) -> json().
string(Input) ->
    gleam_json_ffi:string(Input).

-file("/home/eli/dev/reference/build/packages/gleam_json/src/gleam/json.gleam", 175).
-spec bool(boolean()) -> json().
bool(Input) ->
    gleam_json_ffi:bool(Input).

-file("/home/eli/dev/reference/build/packages/gleam_json/src/gleam/json.gleam", 192).
-spec int(integer()) -> json().
int(Input) ->
    gleam_json_ffi:int(Input).

-file("/home/eli/dev/reference/build/packages/gleam_json/src/gleam/json.gleam", 209).
-spec float(float()) -> json().
float(Input) ->
    gleam_json_ffi:float(Input).

-file("/home/eli/dev/reference/build/packages/gleam_json/src/gleam/json.gleam", 226).
-spec null() -> json().
null() ->
    gleam_json_ffi:null().

-file("/home/eli/dev/reference/build/packages/gleam_json/src/gleam/json.gleam", 248).
-spec nullable(gleam@option:option(FXG), fun((FXG) -> json())) -> json().
...
-file("/home/eli/dev/reference/build/packages/gleam_json/src/gleam/json.gleam", 267).
-spec object(list({binary(), json()})) -> json().
object(Entries) ->
    gleam_json_ffi:object(Entries).

-file("/home/eli/dev/reference/build/packages/gleam_json/src/gleam/json.gleam", 299).
-spec preprocessed_array(list(json())) -> json().
preprocessed_array(From) ->
    gleam_json_ffi:array(From).

-file("/home/eli/dev/reference/build/packages/gleam_json/src/gleam/json.gleam", 284).
-spec array(list(FXK), fun((FXK) -> json())) -> json().
