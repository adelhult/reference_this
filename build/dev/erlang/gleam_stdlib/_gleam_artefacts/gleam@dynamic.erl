...
-file("/home/eli/dev/reference/build/packages/gleam_stdlib/src/gleam/dynamic.gleam", 31).
-spec from(any()) -> dynamic_().
from(A) ->
    gleam_stdlib:identity(A).

-file("/home/eli/dev/reference/build/packages/gleam_stdlib/src/gleam/dynamic.gleam", 39).
-spec dynamic(dynamic_()) -> {ok, dynamic_()} | {error, list(decode_error())}.
dynamic(Value) ->
    {ok, Value}.

-file("/home/eli/dev/reference/build/packages/gleam_stdlib/src/gleam/dynamic.gleam", 60).
-spec bit_array(dynamic_()) -> {ok, bitstring()} | {error, list(decode_error())}.
bit_array(Data) ->
    gleam_stdlib:decode_bit_array(Data).

-file("/home/eli/dev/reference/build/packages/gleam_stdlib/src/gleam/dynamic.gleam", 107).
-spec put_expected(decode_error(), binary()) -> decode_error().
put_expected(Error, Expected) ->
    erlang:setelement(2, Error, Expected).

-file("/home/eli/dev/reference/build/packages/gleam_stdlib/src/gleam/dynamic.gleam", 118).
-spec classify(dynamic_()) -> binary().
classify(Data) ->
    gleam_stdlib:classify_dynamic(Data).

-file("/home/eli/dev/reference/build/packages/gleam_stdlib/src/gleam/dynamic.gleam", 141).
-spec int(dynamic_()) -> {ok, integer()} | {error, list(decode_error())}.
int(Data) ->
    gleam_stdlib:decode_int(Data).

-file("/home/eli/dev/reference/build/packages/gleam_stdlib/src/gleam/dynamic.gleam", 164).
-spec float(dynamic_()) -> {ok, float()} | {error, list(decode_error())}.
float(Data) ->
    gleam_stdlib:decode_float(Data).

-file("/home/eli/dev/reference/build/packages/gleam_stdlib/src/gleam/dynamic.gleam", 187).
-spec bool(dynamic_()) -> {ok, boolean()} | {error, list(decode_error())}.
bool(Data) ->
    gleam_stdlib:decode_bool(Data).

-file("/home/eli/dev/reference/build/packages/gleam_stdlib/src/gleam/dynamic.gleam", 213).
-spec shallow_list(dynamic_()) -> {ok, list(dynamic_())} |
    {error, list(decode_error())}.
shallow_list(Value) ->
    gleam_stdlib:decode_list(Value).

-file("/home/eli/dev/reference/build/packages/gleam_stdlib/src/gleam/dynamic.gleam", 356).
-spec optional(fun((dynamic_()) -> {ok, DOR} | {error, list(decode_error())})) -> fun((dynamic_()) -> {ok,
        gleam@option:option(DOR)} |
    {error, list(decode_error())}).
optional(Decode) ->
    fun(Value) -> gleam_stdlib:decode_option(Value, Decode) end.

-file("/home/eli/dev/reference/build/packages/gleam_stdlib/src/gleam/dynamic.gleam", 491).
...
-file("/home/eli/dev/reference/build/packages/gleam_stdlib/src/gleam/dynamic.gleam", 1021).
-spec any(list(fun((dynamic_()) -> {ok, DSR} | {error, list(decode_error())}))) -> fun((dynamic_()) -> {ok,
        DSR} |
    {error, list(decode_error())}).
any(Decoders) ->
...
-file("/home/eli/dev/reference/build/packages/gleam_stdlib/src/gleam/dynamic.gleam", 1517).
...
-file("/home/eli/dev/reference/build/packages/gleam_stdlib/src/gleam/dynamic.gleam", 1054).
-spec decode1(
    fun((DSV) -> DSW),
...
-file("/home/eli/dev/reference/build/packages/gleam_stdlib/src/gleam/dynamic.gleam", 563).
...
-file("/home/eli/dev/reference/build/packages/gleam_stdlib/src/gleam/dynamic.gleam", 248).
-spec result(
    fun((dynamic_()) -> {ok, DOF} | {error, list(decode_error())}),
    fun((dynamic_()) -> {ok, DOH} | {error, list(decode_error())})
) -> fun((dynamic_()) -> {ok, {ok, DOF} | {error, DOH}} |
    {error, list(decode_error())}).
...
-file("/home/eli/dev/reference/build/packages/gleam_stdlib/src/gleam/dynamic.gleam", 301).
-spec list(fun((dynamic_()) -> {ok, DOM} | {error, list(decode_error())})) -> fun((dynamic_()) -> {ok,
        list(DOM)} |
    {error, list(decode_error())}).
list(Decoder_type) ->
    fun(Dynamic) ->
...
-file("/home/eli/dev/reference/build/packages/gleam_stdlib/src/gleam/dynamic.gleam", 87).
-spec map_errors(
    {ok, DNA} | {error, list(decode_error())},
...
-file("/home/eli/dev/reference/build/packages/gleam_stdlib/src/gleam/dynamic.gleam", 95).
...
-file("/home/eli/dev/reference/build/packages/gleam_stdlib/src/gleam/dynamic.gleam", 83).
-spec string(dynamic_()) -> {ok, binary()} | {error, list(decode_error())}.
string(Data) ->
    decode_string(Data).

-file("/home/eli/dev/reference/build/packages/gleam_stdlib/src/gleam/dynamic.gleam", 385).
-spec field(
    any(),
...
-file("/home/eli/dev/reference/build/packages/gleam_stdlib/src/gleam/dynamic.gleam", 427).
-spec optional_field(
    any(),
    fun((dynamic_()) -> {ok, DPF} | {error, list(decode_error())})
) -> fun((dynamic_()) -> {ok, gleam@option:option(DPF)} |
    {error, list(decode_error())}).
...
-file("/home/eli/dev/reference/build/packages/gleam_stdlib/src/gleam/dynamic.gleam", 470).
-spec element(
    integer(),
...
-file("/home/eli/dev/reference/build/packages/gleam_stdlib/src/gleam/dynamic.gleam", 553).
...
-file("/home/eli/dev/reference/build/packages/gleam_stdlib/src/gleam/dynamic.gleam", 629).
-spec tuple2(
    fun((dynamic_()) -> {ok, DQN} | {error, list(decode_error())}),
    fun((dynamic_()) -> {ok, DQP} | {error, list(decode_error())})
) -> fun((dynamic_()) -> {ok, {DQN, DQP}} | {error, list(decode_error())}).
...
-file("/home/eli/dev/reference/build/packages/gleam_stdlib/src/gleam/dynamic.gleam", 698).
-spec tuple3(
...
) -> fun((dynamic_()) -> {ok, {DQS, DQU, DQW}} | {error, list(decode_error())}).
...
-file("/home/eli/dev/reference/build/packages/gleam_stdlib/src/gleam/dynamic.gleam", 769).
-spec tuple4(
...
) -> fun((dynamic_()) -> {ok, {DQZ, DRB, DRD, DRF}} |
    {error, list(decode_error())}).
...
-file("/home/eli/dev/reference/build/packages/gleam_stdlib/src/gleam/dynamic.gleam", 842).
-spec tuple5(
...
) -> fun((dynamic_()) -> {ok, {DRI, DRK, DRM, DRO, DRQ}} |
    {error, list(decode_error())}).
...
-file("/home/eli/dev/reference/build/packages/gleam_stdlib/src/gleam/dynamic.gleam", 917).
-spec tuple6(
...
) -> fun((dynamic_()) -> {ok, {DRT, DRV, DRX, DRZ, DSB, DSD}} |
    {error, list(decode_error())}).
...
-file("/home/eli/dev/reference/build/packages/gleam_stdlib/src/gleam/dynamic.gleam", 968).
-spec dict(
    fun((dynamic_()) -> {ok, DSG} | {error, list(decode_error())}),
    fun((dynamic_()) -> {ok, DSI} | {error, list(decode_error())})
) -> fun((dynamic_()) -> {ok, gleam@dict:dict(DSG, DSI)} |
    {error, list(decode_error())}).
...
-file("/home/eli/dev/reference/build/packages/gleam_stdlib/src/gleam/dynamic.gleam", 1082).
-spec decode2(
    fun((DSZ, DTA) -> DTB),
...
-file("/home/eli/dev/reference/build/packages/gleam_stdlib/src/gleam/dynamic.gleam", 1114).
-spec decode3(
    fun((DTF, DTG, DTH) -> DTI),
...
-file("/home/eli/dev/reference/build/packages/gleam_stdlib/src/gleam/dynamic.gleam", 1160).
-spec decode4(
    fun((DTN, DTO, DTP, DTQ) -> DTR),
...
-file("/home/eli/dev/reference/build/packages/gleam_stdlib/src/gleam/dynamic.gleam", 1216).
-spec decode5(
    fun((DTX, DTY, DTZ, DUA, DUB) -> DUC),
...
-file("/home/eli/dev/reference/build/packages/gleam_stdlib/src/gleam/dynamic.gleam", 1276).
-spec decode6(
    fun((DUJ, DUK, DUL, DUM, DUN, DUO) -> DUP),
...
-file("/home/eli/dev/reference/build/packages/gleam_stdlib/src/gleam/dynamic.gleam", 1341).
-spec decode7(
    fun((DUX, DUY, DUZ, DVA, DVB, DVC, DVD) -> DVE),
...
-file("/home/eli/dev/reference/build/packages/gleam_stdlib/src/gleam/dynamic.gleam", 1410).
-spec decode8(
    fun((DVN, DVO, DVP, DVQ, DVR, DVS, DVT, DVU) -> DVV),
    ...
    fun((dynamic_()) -> {ok, DVS} | {error, list(decode_error())}),
...
-file("/home/eli/dev/reference/build/packages/gleam_stdlib/src/gleam/dynamic.gleam", 1483).
-spec decode9(
    fun((DWF, DWG, DWH, DWI, DWJ, DWK, DWL, DWM, DWN) -> DWO),
