...
-file("/home/eli/dev/reference/build/packages/glint/src/glint/internal/help.gleam", 13).
...
-file("/home/eli/dev/reference/build/packages/glint/src/glint/internal/help.gleam", 131).
...
-file("/home/eli/dev/reference/build/packages/glint/src/glint/internal/help.gleam", 218).
...
-file("/home/eli/dev/reference/build/packages/glint/src/glint/internal/help.gleam", 111).
...
-file("/home/eli/dev/reference/build/packages/glint/src/glint/internal/help.gleam", 119).
...
-file("/home/eli/dev/reference/build/packages/glint/src/glint/internal/help.gleam", 285).
...
-file("/home/eli/dev/reference/build/packages/glint/src/glint/internal/help.gleam", 258).
-spec to_spaced_indented_string(
    list(GPS),
    fun((GPS) -> {binary(), binary()}),
    integer(),
    config()
) -> binary().
...
-file("/home/eli/dev/reference/build/packages/glint/src/glint/internal/help.gleam", 191).
...
-file("/home/eli/dev/reference/build/packages/glint/src/glint/internal/help.gleam", 231).
...
-file("/home/eli/dev/reference/build/packages/glint/src/glint/internal/help.gleam", 142).
...
-file("/home/eli/dev/reference/build/packages/glint/src/glint/internal/help.gleam", 84).
